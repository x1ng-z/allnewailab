 ...
 */
@Configuration
@MapperScan(basePackages = {"hs.industry.ailab.dao.mysql"},annotationClass = Repository.class,sqlSessionFactoryRef = "mysqlsessionfactory" )
...
//        String packageXMLConfigPath = PathMatchingResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX + mapperXMLConfigPath;
        sqlSessionFactoryBean.setConfigLocation(resolver.getResource(config_locations));
