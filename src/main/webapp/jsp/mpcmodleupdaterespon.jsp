        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content  layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="refrencemodleId" value="${respontimeserise.refrencemodleId}" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">

                    <input type="text" name="responid" value="${respontimeserise.modleresponId}" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                        ...
                        <div class="layui-input-inline">
                            <select name="inputpinName" lay-verify="required" lay-search>
                                ...
                                <c:forEach var="pinindex" items="${userinputpinscope}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${respontimeserise.inputPins.equals(pinindex.modlePinName)}">
                                            <option value="${pinindex.modlePinName}" selected>${pinindex.modlePinName}</option>
                                        </c:when>
                                        <c:otherwise>
                        ...
                        <div class="layui-input-inline">
                            <select name="outputpinName" lay-verify="required" lay-search>
                                ...
                                <c:forEach var="pinindex" items="${useroutputpinscope}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${respontimeserise.outputPins.equals(pinindex.modlePinName)}">
                                            <option value="${pinindex.modlePinName}" selected>${pinindex.modlePinName}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${pinindex.modlePinName}">${pinindex.modlePinName}</option>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="K" autocomplete="off" class="layui-input"
                                   placeholder="K值" value="${K}" lay-verify="required" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="T" autocomplete="off" class="layui-input"
                                   placeholder="T值" value="${T}" lay-verify="required" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="Tau" autocomplete="off" class="layui-input"
                                   placeholder="Tau值" value="${Tau}" lay-verify="required" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="Ki" autocomplete="off" class="layui-input"
                                   placeholder="积分比例/60s" value="${Ki}" lay-verify="required" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="effectRatio" autocomplete="off" class="layui-input"
                                   placeholder="pv对mv的输出占比" value="${respontimeserise.effectRatio}" lay-verify="required" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['element', 'form', 'layer'], function () {
        ...
        form.on('submit(newresponsubmit)', function (data) {
            ...
            let url = "/projectedit/updatempcmodlerespon";
