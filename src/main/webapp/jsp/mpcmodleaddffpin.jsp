        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content  layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="ffpinid" value="" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="ffpincontantvalue" autocomplete="off" class="layui-input"
                                   value="" id="ffpincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content  layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="ffuppinid" value="" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="ffuppincontantvalue" autocomplete="off" class="layui-input"
                                   value="" id="ffuppincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="ffupmodleOpcTag" lay-search=""
                                ...
                                <option value="">请选择</option>
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <option value="${point.modlePinName}" ffupresourcemodleId="${point.refmodleId}"
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content  layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="ffdownpinid" value="" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="ffdownpincontantvalue" autocomplete="off" class="layui-input"
                                   value="" id="ffdownpincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="ffdownmodleOpcTag" lay-search=""
                                ...
                                <option value="">请选择</option>
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <option value="${point.modlePinName}" ffdownresourcemodleId="${point.refmodleId}"
