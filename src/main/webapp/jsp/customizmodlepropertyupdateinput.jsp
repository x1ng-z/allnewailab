...
<head>
    ...
    <meta charset="utf-8">
    <title>update customizmodle property</title>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" name="modlepinsId" value="${customizmodle.modlepinsId}"
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" name="pindir" value="${customizmodle.pindir}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;" />
                </div>
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="modlePinName" lay-verify="required" autocomplete="off" class="layui-input"
                           value="${customizmodle.modlePinName}" id="modlePinNameid">
                </div>
            </div>
...
<%--                            <c:choose>--%>
<%--                                <c:when test="${point.modlepinsId==customizmodle.resource.getInteger('modlepinsId')}">--%>
    ...
    $(document).ready(function () {
        ...
        layui.use(['element', 'form', 'layer'], function () {
            ...
            layer =parent.layer === undefined ? layui.layer : parent.layer;
             ${customizmodle.resource.getString('resource')=='constant'||customizmodle.resource.getString('resource')!='modle'}? $('#modlePincontantvalueid').removeAttr('disabled'):$('#modlePincontantvalueid').attr('disabled',true) ;
            form.render(); //更新全部
