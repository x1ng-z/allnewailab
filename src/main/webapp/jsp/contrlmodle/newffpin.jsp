                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ff" autocomplete="off" class="layui-input"
                                   placeholder="ff位号" lay-verify="required">
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content   layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="ffpinfilterid" value="" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="filtercoefff" autocomplete="off" class="layui-input"
                                   placeholder="ff滤波系数" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ffdown" autocomplete="off" class="layui-input"
                                   placeholder="ffdown位号/值" lay-verify="required">
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['element', 'form', 'layer'], function () {
        ...
        form.on('submit(newcontrlmodlepinsubmit)', function (data) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/contrlmodle/savenewmodelffpin.do",
                async: true,
                data: {
