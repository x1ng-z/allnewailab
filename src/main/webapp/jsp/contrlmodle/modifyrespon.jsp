        ...
        <div class="layui-colla-item"  >
            ...
            <div class="layui-colla-content  layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="responid" value="${respontimeserise.modletagId}" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
...
<script>
    ...
    layui.use(['element', 'form', 'layer'], function () {
        ...
        form.on('submit(newresponsubmit)', function (data) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/contrlmodle/savemodifyrespon.do",
                async: true,
                data: {
                    "responcontext": JSON.stringify(data.field),
                },
                type: "POST",
