...
<form class="layui-form" action="" method="post">
    <div class="layui-form-item layui-collapse" lay-accordion>
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="modleid" value="${mvpin.reference_modleId}" autocomplete="off"
                           class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">


                    <input type="text" name="mvpinid" autocomplete="off" class="layui-input"
                           value="${mvpin.modlepinsId}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mv" autocomplete="off" class="layui-input" lay-verify="required"
                                   placeholder="opc位号" value="${mvpin.modleOpcTag}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mvcomment" autocomplete="off" class="layui-input"
                                   placeholder="mv中文注释" value="${mvpin.opcTagName}">
                        </div>
                    </div>
                        ...
                        <div class="layui-input-inline">
                            <select name="mvresource" lay-verify="required">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${(mvpin.resource!=null) && (mvpin.resource.equals(opcres))}">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="r" autocomplete="off" class="layui-input" lay-verify="required"
                                   placeholder="mv的R" onmousewheel='scrollFunc()' value="${mvpin.r}">
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                ...
                <div class="layui-form-item">
                    <input type="text" name="mvenableid" value="${mvpinenable.modlepinsId}" autocomplete="off"
                           class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mvenable" autocomplete="off" class="layui-input"
                                   placeholder="opc位号" value="${mvpinenable.modleOpcTag}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="mvenableresource">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${(mvpinenable.resource!=null) && (mvpinenable.resource.equals(opcres))}">
                                            <option value="${opcres}" selected>${opcres}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${opcres}">${opcres}</option>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="dmvHigh" autocomplete="off" class="layui-input"
                                   lay-verify="required"
                                   placeholder="dmvHigh" onmousewheel='scrollFunc()' value="${mvpin.dmvHigh}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="dmvLow" autocomplete="off" class="layui-input"
                                   lay-verify="required"
                                   placeholder="dmvLow" onmousewheel='scrollFunc()' value="${mvpin.dmvLow}">
                        </div>
                    </div>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="mvuppinid" autocomplete="off" class="layui-input"
                           value="${mvuppin.modlepinsId}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mvup" autocomplete="off" class="layui-input" lay-verify="required"
                                   placeholder="mv上限" value="${mvuppin.modleOpcTag}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="mvupresource" lay-verify="required">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${(mvuppin.resource!=null) && (mvuppin.resource.equals(opcres))}">
                                            <option value="${opcres}" selected>${opcres}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${opcres}">${opcres}</option>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mvdown" autocomplete="off" class="layui-input"
                                   lay-verify="required"
                                   placeholder="mv下限" value="${mvdownpin.modleOpcTag}"
                            >
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="mvdownresource" lay-verify="required">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${mvdownpin.resource!=null&&mvdownpin.resource.equals(opcres)}">
                                            <option value="${opcres}" selected>${opcres}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${opcres}">${opcres}</option>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mvfbcomment" autocomplete="off" class="layui-input"
                                   placeholder="mvfb中文注释" value="${mvfbpin.opcTagName}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="mvfbresource" lay-verify="required">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${mvfbpin.resource!=null&&mvfbpin.resource.equals(opcres)}">
                                            <option value="${opcres}" selected>${opcres}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${opcres}">${opcres}</option>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="mvfbfilterpinid" autocomplete="off" class="layui-input" value="${mvfbpin.filter.pk_filterid}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="filternamemv">
                                ...
                                <c:choose>
                                    <c:when test="${mvfbpin.filter.filtername eq 'mvav'}">
                                ...
                                <c:choose>
                                    <c:when test="${mvfbpin.filter.filtername eq 'fodl'}">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="filtercoefmv" autocomplete="off"
                                   class="layui-input"
                                   onmousewheel='scrollFunc()' value="${mvfbpin.filter.getcoeff()}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="filteropctagmv" autocomplete="off"
                                   class="layui-input" value="${mvfbpin.filter.backToDCSTag}">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="filtermvfbresource">
                                ...
                                <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                    <c:choose>
                                        <c:when test="${mvfbpin.filter.opcresource!=null&&mvfbpin.filter.opcresource.equals(opcres)}">
                                            <option value="${opcres}" selected>${opcres}</option>
                                        </c:when>
                                        <c:otherwise>
                                            <option value="${opcres}">${opcres}</option>
                ...
                <div class="layui-form-item layui-collapse" lay-accordion>
                    <div class="layui-colla-item">
                        ...
                        <div class="layui-colla-content">
                            ...
                            <input type="text" name="mvfbshockerid" autocomplete="off" class="layui-input" value="${mvpin.shockDetector.pk_shockdetectid}"
                                   style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="detectwindowstimemv" autocomplete="off"
                                           class="layui-input"
                                           placeholder="mv震荡监视时间" onmousewheel='scrollFunc()' value="${mvpin.shockDetector.windowstime}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="detectdampcoemv" autocomplete="off"
                                           class="layui-input"
                                           placeholder="mv阻尼系数" onmousewheel='scrollFunc()' value="${mvpin.shockDetector.dampcoeff}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" name="detectfiltercoemv" autocomplete="off"
                                           class="layui-input"
                                           placeholder="mv滤波系数" onmousewheel='scrollFunc()' value="${mvpin.shockDetector.filtercoeff}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="detectfilteroutopctagmv"
                                           autocomplete="off"
                                           class="layui-input"
                                           placeholder="mv滤波输出位号" value="${mvpin.shockDetector.filterbacktodcstag}">
                                </div>
                            </div>
                                ...
                                <div class="layui-input-inline">
                                    <select name="detectfilteroutopctagmvresource">
                                        ...
                                        <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                            ...
                                            <c:choose>
                                                <c:when test="${mvpin.shockDetector.filteropcresource!=null&&mvpin.shockDetector.filteropcresource.equals(opcres)}">
                                                    <option value="${opcres}" selected>${opcres}</option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option value="${opcres}">${opcres}</option>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="detectamplitudeoutopctagmv"
                                           autocomplete="off"
                                           class="layui-input"
                                           placeholder="mv幅值输出位号" value="${mvpin.shockDetector.backToDCSTag}">
                                </div>
                            </div>
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <select name="detectamplitudeoutopctagmvresource">
                                        ...
                                        <c:forEach var="opcres" items="${opcresources}" varStatus="Count">
                                            <c:choose>
                                                <c:when test="${mvpin.shockDetector.opcresource!=null&&mvpin.shockDetector.opcresource.equals(opcres)}">
                                                    <option value="${opcres}" selected>${opcres}</option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option value="${opcres}">${opcres}</option>
    ...
    <div class="layui-input-block">
        <button type="submit" class="layui-btn" lay-submit="" id="modifycontrlmodlepinsubmitbt"
                lay-filter="modifycontrlmodlepinsubmit"
...
<script>
    ...
    layui.use(['element', 'form', 'layer'], function () {
        ...
        //监听提交
        form.on('submit(modifycontrlmodlepinsubmit)', function (data) {
            let index = layer.msg('修改中，请稍候', {icon: 16, time: false, shade: 0.8});
            $.ajax({
                url: "${pageContext.request.contextPath}/contrlmodle/savemodifymodelmvpin.do",
                async: true,
                data: {
