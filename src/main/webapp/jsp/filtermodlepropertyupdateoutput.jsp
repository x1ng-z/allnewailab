                        ...
                        <c:forEach items="${points}" var="point" varStatus="Count">
                            <c:choose>
                                <c:when test="${point.modlepinsId==baseModlePropertyImp.resource.getInteger('modlepinsId')}">
                                    <option value="${point.modlePinName}"  resourcemodleId="${point.refmodleId}" resourcemodlepinsId="${point.modlepinsId}" selected>${point.modlePinName}(${point.opcTagName})</option>
                                </c:when>
                                <c:otherwise>
                                    <option value="${point.modlePinName}"  resourcemodleId="${point.refmodleId}" resourcemodlepinsId="${point.modlepinsId}">${point.modlePinName}(${point.opcTagName})</option>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </select>
