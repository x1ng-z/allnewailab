        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    <input type="text" name="refmodleId" value="${modleId}" autocomplete="off" class="layui-input"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">

                    <input type="text" name="modlepinsId" autocomplete="off" class="layui-input" value=""
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="pvpincontantvalue" autocomplete="off" class="layui-input"
                                   value="" id="pvpincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                                ...
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <optgroup label="${point.key}">
                                        <c:forEach items="${point.value}" var="parentpin">
                                            <option value="${parentpin.modlepinsId}_${parentpin.modlePinName}" pvresourcemodleId="${parentpin.refmodleId}"
                                                    pvresourcemodlepinsId="${parentpin.modlepinsId}">${parentpin.modlePinName}(${parentpin.opcTagName})</option>
                                        </c:forEach>
                                    </optgroup>
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="Q" autocomplete="off" class="layui-input" lay-verify="required|number"
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="pvuppinid" autocomplete="off" class="layui-input" value=""
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="pvuppincontantvalue" autocomplete="off" class="layui-input"
                                   placeholder="pvup位号/值" id="pvuppincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="pvupmodleOpcTag"  lay-search=""
                                ...
                                <option value="">请选择</option>
<%--                                <c:forEach items="${points}" var="point" varStatus="Count">--%>
<%--                                    <option value="${point.modlePinName}" pvupresourcemodleId="${point.refmodleId}"--%>
...
<%--                                </c:forEach>--%>
                                ...
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <optgroup label="${point.key}">
                                        <c:forEach items="${point.value}" var="parentpin">
                                            <option value="${parentpin.modlepinsId}_${parentpin.modlePinName}" pvupresourcemodleId="${parentpin.refmodleId}"
                                                    pvupresourcemodlepinsId="${parentpin.modlepinsId}">${parentpin.modlePinName}(${parentpin.opcTagName})</option>
                                        </c:forEach>
                                    </optgroup>
                    ...
                    <input type="text" name="pvdownpinid" autocomplete="off" class="layui-input" value=""
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="pvdownpincontantvalue" autocomplete="off" class="layui-input"
                                   placeholder="pvdown位号/值" id="pvdownpincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="pvdownmodleOpcTag"  lay-search=""
                                ...
                                <option value="">请选择</option>
<%--                                <c:forEach items="${points}" var="point" varStatus="Count">--%>
<%--                                    <option value="${point.modlePinName}" pvdownresourcemodleId="${point.refmodleId}"--%>
...
<%--                                </c:forEach>--%>
                                ...
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <optgroup label="${point.key}">
                                        <c:forEach items="${point.value}" var="parentpin">
                                            <option value="${parentpin.modlepinsId}_${parentpin.modlePinName}" pvdownresourcemodleId="${parentpin.refmodleId}"
                                                    pvdownresourcemodlepinsId="${parentpin.modlepinsId}">${parentpin.modlePinName}(${parentpin.opcTagName})</option>
                                        </c:forEach>
                                    </optgroup>
        ...
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content  layui-show">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="sppinid" autocomplete="off" class="layui-input" value=""
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="sppincontantvalue" autocomplete="off" class="layui-input"
                                   placeholder="sp位号/值" id="sppincontantvalueid" onmousewheel='scrollFunc()'>
                        </div>
                    </div>
...
<%--                                </c:forEach>--%>
                                ...
                                <c:forEach items="${points}" var="point" varStatus="Count">
                                    <optgroup label="${point.key}">
                                        <c:forEach items="${point.value}" var="parentpin">
                                            <option value="${parentpin.modlepinsId}_${parentpin.modlePinName}" spresourcemodleId="${parentpin.refmodleId}"
                                                    spresourcemodlepinsId="${parentpin.modlepinsId}">${parentpin.modlePinName}(${parentpin.opcTagName})</option>
                                        </c:forEach>
                                    </optgroup>
    ...
    $(document).ready(function () {
        ...
        layui.use(['element', 'form', 'layer'], function () {
            ...
            form.on('submit(newcontrlmodlepinsubmit)', function (data) {
                ...
                let url = "/projectedit/creatempcmodleproperties";
