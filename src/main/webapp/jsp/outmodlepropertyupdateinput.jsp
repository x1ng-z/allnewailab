        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" name="inmodlepinsId" value="${inputproperty.modlepinsId}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;" />
                </div>
            </div>
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" name="outmodlepinsId" value="${outproperty.modlepinsId}"
                           style="visibility: hidden;width: 0px;height: 0px;z-index: -99;" />
                </div>
            </div>
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="modlePinName"  lay-verify="required" autocomplete="off" class="layui-input"
                           value="${inputproperty.modlePinName}" id="modlePinNameid">
                </div>
            </div>
