    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="modleId" value="${inputmodle.modleId}"  style="visibility: hidden;width: 0px;height: 0px;z-index: -99;"/>
            </div>
        </div>
        <div class="layui-inline">
            <input type="text" name="modletype" value="${inputmodle.modletype}" autocomplete="off"
                   class="layui-input"
        ...
        table.on('toolbar(pvtable)', function (obj) {
            ...
            switch (obj.event) {
                case 'addpvpin':
                    ...
                    let modletype='${inputmodle.modletype}';
                    let modleId='${inputmodle.modleId}';
                    let pindir='output';
